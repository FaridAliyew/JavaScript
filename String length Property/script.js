...
// const myFunc = () => {
//     if (strOne.trim() != null && strTwo.trim() != null && strOne.trim() != "" && strTwo.trim() != "") {
//         if (strOne.trim().length > strTwo.trim().length) {
...
//         } else if (strOne.trim().length == strTwo.trim().length) {
//             document.getElementById("p1").innerText = "Birinci String: " + strOne;
//             document.getElementById("p2").innerText = "Ikinci String: " + strTwo;
//             document.getElementById("p3").innerText = "Result: Birinci String" + " " + " = " + " " + "Ikinci stringə";
//         } else {
//             document.getElementById("p1").innerText = "Birinci String: " + strOne;
//             document.getElementById("p2").innerText = "Ikinci String: " + strTwo;
...
//         }
//     } else {
//         alert("Zehmet olmasa bir string daxil edin");
//     }
